...
public class InsertEnderecoPsicologo extends javax.swing.JFrame {

    public InsertEnderecoPsicologo() {
        initComponents();
        /*Icon Janela*/
    ...
    private void btnInserirEnderecoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInserirEnderecoActionPerformed
        ...
        try {
            ...
            psicologodao.createEnderecoPsicologo(endereco);
            InsertDadosPsicologo clickNextPage = new InsertDadosPsicologo();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsertEnderecoPsicologo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InsertEnderecoPsicologo().setVisible(true);
            }
        });
    }
