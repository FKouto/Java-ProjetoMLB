...
public class SelectedDelPsiquiatra extends javax.swing.JFrame {

    /**
     * Creates new form SelectedDelPaciente
     */
    public SelectedDelPsiquiatra() {
        initComponents();
        /*Icon Janela*/
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        try {
            Psiquiatra psiquiatra = new Psiquiatra(idDelete,"","","","","");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectedDelPsiquiatra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SelectedDelPsiquiatra().setVisible(true);
            }
        });
    }
